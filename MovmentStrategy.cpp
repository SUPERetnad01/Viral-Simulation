...
void RegularMovementStrategy::set_mod(double mod ){};
...
void LockDownMovementStrategy::set_mod(double mod ){};
...
void ExitMovementStrategy::set_mod(double mod ){ _modifier = mod ;};